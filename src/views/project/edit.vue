  ...
  <div>
    <el-form ref="form" :model="form" :rules="rules" style="margin-top: 6px" size="small" label-width="100px">
      ...
      <el-form-item label="附件上传" prop="upload">
        <el-upload ref="upload" :before-upload="beforeUpload" :auto-upload="true" :data="uploadData" :headers="headers"
          :on-preview="seeThisOne" :on-remove="handleRemove" :before-remove="beforeRemove" :on-success="handleSuccess"
          :file-list="fileList" :on-error="handleError" :action="annexUploadApi">
...
<script>
  ...
  import { delFiles } from "@/api/project";

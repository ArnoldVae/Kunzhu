  ...
  <div class="app-container">
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
        ...
        <el-form-item label="性别" prop="gender">
          <el-select v-model="form.gender" style="width: 500px" placeholder="请选择">
    ...
    >
      ...
      <el-table-column prop="enabled" width="160px" label="启用状态">
        <template slot-scope="scope">
          <el-switch v-model="scope.row.enabled" active-text="开启" inactive-text="关闭" @change="statusChange(scope.row)" />
